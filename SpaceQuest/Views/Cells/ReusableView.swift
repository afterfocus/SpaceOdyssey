...
/// Расширение для ячеек TableView и CollectionView, позволяющее извлекать их не указывая reuseIdentifier (в InterfaceBuilder следует указать reuseIdentifier идентичным названию класса ячейки)
